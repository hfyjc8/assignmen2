...
CREATE TABLE `city` (
  ...
  CONSTRAINT `city_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`)
...
CREATE TABLE `country` (
  ...
  `Gov_Form` char(45) NOT NULL DEFAULT '',
...
CREATE TABLE `countrylanguage` (
  ...
  KEY `CountryCode` (`CountryCode`),
  CONSTRAINT `countryLanguage_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
