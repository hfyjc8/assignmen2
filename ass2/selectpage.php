...
<header>
	...
	<h1>Select Menu</h1>
	<div class="box">
	<button class="btn" onclick="window.location.href = 'selectpagecity.php';">City</button>
	<button class="btn" onclick="window.location.href = 'selectpagecountry.php';">Country</button>
	<button class="btn" onclick="window.location.href = 'selectpagelanguage.php';">Language</button>
